   ...
   <section class="about">
      ...
      <div class="row">
         ...
         <div class="box">
            ...
            <p>Tour And Travel offers a wide range of high-quality electronics to keep you connected and ahead in the digital age. From the latest laptops and mobile phones to powerful PCs and monitors, we ensure you have access to the best tech products.</p>
            <a href="contact.php" class="btn">contact us</a>
         </div>

         <div class="box">
            <h3>What We Provide?</h3>
            <p>At Tour And Travel, we understand the importance of reliable and advanced technology. We provide top-tier electronics including the latest laptops, mobile phones, PCs, and monitors. Our products come with guaranteed quality and we offer fast and secure delivery to your doorstep. Experience the best of technology with us.</p>
            <a href="Destination.php" class="btn">our Destination</a>
         </div>
